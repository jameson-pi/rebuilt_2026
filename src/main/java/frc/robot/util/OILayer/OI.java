...
public interface OI {
    ...
    public final ControlCurve driveTranslationCurve = new ControlCurve(1, 3, 0.2, false);
    public final ControlCurve driveRotationCurve = new ControlCurve(1, 3, 0.2, false);
